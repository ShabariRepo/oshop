...
export class ShoppingCartService {
  ...
  // the : Primise<string> is an annotation that will tell intellisense that that is what it returns so when you hover over the callback var it will show that
